...
/*    {
    ...
    public boolean delete(int id) {
        log.info("delete {}", id);
        return repository.values().removeIf(user -> user.getId().equals(id));
    }
    ...
    public List<User> getAll() {
        log.info("getAll");
        return getSortNameUser(new ArrayList<>(repository.values()));
    }
    ...
    private List<User> getSortNameUser(List<User> users) {
